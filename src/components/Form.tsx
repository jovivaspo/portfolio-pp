...
export const Form = () => {
  ...
  return (
    <form
      id="formulario"
      className="mx-auto flex flex-col justify-center items-center gap-8  bg-slate-100 p-4 pt-16 w-full md:w-[80%] lg:w-[780px]"
    >
      <div className="flex flex-col gap-2 w-[90%] md:max-w-[720px]">
        ...
        <div className="h-[16px] flex items-start">
          {error && !form.name && (
            <span className="text-red-500 text-xs">Please enter a name</span>
          )}
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2  w-[90%] md:max-w-[680px]">
        ...
        >
          {isSubmit && <SpinnerCircular color="white" size={20} />}
          Submit
        </button>
      </div>
    </form>
